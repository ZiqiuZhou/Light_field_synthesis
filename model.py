...
class DepthNetModel(nn.Module):
    def __init__(self):
        ...
        self.layer = nn.Sequential(
            nn.Conv2d(80, 40, 7, stride=1),
            nn.ReLU(),
            nn.Conv2d(40, 40, 5, stride=1),
            nn.ReLU(),
            nn.Conv2d(40, 20, 3, stride=1),
            nn.ReLU(),
            nn.Conv2d(20, 1, 1, stride=1),
        )
...
class ColorNetModel(nn.Module):
    def __init__(self):
        ...
        self.layer = nn.Sequential(
            nn.Conv2d(15, 40, 7, stride=1), # 3N + 3, N = 4
            nn.ReLU(),
            nn.Conv2d(40, 40, 5, stride=1),
            nn.ReLU(),
            nn.Conv2d(40, 20, 3, stride=1),
            nn.ReLU(),
            nn.Conv2d(20, 3, 1, stride=1),
        )
