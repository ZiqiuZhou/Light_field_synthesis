...
def synthesize_novel_views(depth_net, color_net, inputLF, fullLF, resultPath, deltaDisparity):
    ...
    for vi in range(numNovelViews):
        ...
        print('**********************************')
        synthesizedView = evaluate_system(depth_net, color_net, images=inputLF, refPos=curRefPos, disparity=deltaDisparity)
...
def test():
    ...
    for ns in range(numScenes):
        print('**********************************')
        print('Working on the ' + sceneNames[ns] + ' dataset')
        ...
        print('--------------------------')
        synthesize_novel_views(depth_net, color_net, curInputLF, curFullLF, resultPath, deltaDisparity)
        print()
